 ...
 * and every named bone group, on two tabs of the panel (owner, 2026-09-20:
 * one atlas, the reader switches between muscles and bones). No movement,
 * no roles, no curves; click a muscle to isolate it, a bone to light it up.
 */
export const atlas: Exercise = {
  slug: "atlas",
  category: "Atlas",
  name: "Muscles and bones",
  static: true,
  durationMs: 1000,
  anchor: "free",
