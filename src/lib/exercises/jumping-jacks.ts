...
export const jumpingJacks: Exercise = {
  ...
  muscles: [
    ...
    { id: "posterior-deltoid", name: "Posterior deltoid", group: "Shoulder", role: "synergist", note: "Helps raise the arms overhead; the middle deltoid, the main abductor, is not modelled separately.", curve: ARM_UP },
