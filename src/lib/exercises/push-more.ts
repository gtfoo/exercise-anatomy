...
export const pikePushUp: Exercise = {
  ...
  disclaimer:
    "Activation is shown qualitatively by role — prime mover, synergist, stabiliser. The movement is designed, not captured, to the form at sweat.com: an inverted V, the forehead lowered toward the floor and pressed back. Nothing here is estimated or measured. Educational illustration, not training or medical advice.",
  phases: [
