...
export const kettlebellSwing: Exercise = {
  ...
  muscles: [
    { id: "gluteus-maximus", name: "Gluteus maximus", group: "Hip hinge", role: "prime-mover", note: "Snaps the hips forward: the drive that sends the bell up.", curve: DRIVE, stretch: [[0, 0.7], [0.2, 0.3], [0.5, 0.05], [0.8, 0.4], [1, 0.7]] },
    { id: "biceps-femoris", name: "Biceps femoris", group: "Hip hinge", role: "prime-mover", note: "Extends the hip with the glutes and loads like a spring in the hinge.", curve: DRIVE, stretch: [[0, 0.9], [0.2, 0.4], [0.5, 0.05], [0.8, 0.5], [1, 0.9]] },
    { id: "semitendinosus", name: "Semitendinosus", group: "Hip hinge", role: "prime-mover", note: "Hip extension with biceps femoris.", curve: DRIVE, stretch: [[0, 0.9], [0.2, 0.4], [0.5, 0.05], [0.8, 0.5], [1, 0.9]] },
    { id: "semimembranosus", name: "Semimembranosus", group: "Hip hinge", role: "prime-mover", note: "Hip extension with the other hamstrings.", curve: DRIVE, stretch: [[0, 0.85], [0.2, 0.4], [0.5, 0.05], [0.8, 0.5], [1, 0.85]] },
